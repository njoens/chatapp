 ...
 */
Namespace('njoens.ChatController');
 ...
 */
njoens.ChatController = Meteoris.Controller.extend({
    /*
    ...
    getAll: function() {
        return njoens.Chat.find(this.getCriteria(), this.getSortLimit());
    },
    ...
    post: function(t) {
        ...
        njoens.Chat.insert(doc, function(err, _id) {
            if (err) {
