 ...
 */
var ctrl = new njoens.ChatController();

/*
 * subscribe chat from server with criteria from controller and sort limit from controller
 * when template created
 */
Template.njoens_chatIndex.onCreated(function() {
    var self = this;
    self.autorun(function() {
        self.subscribe('njoens_chat', ctrl.getCriteria(), ctrl.getSortLimit());
    });
});

Template.njoens_chatIndex.helpers({
...
Template.njoens_chatIndex.events = {
